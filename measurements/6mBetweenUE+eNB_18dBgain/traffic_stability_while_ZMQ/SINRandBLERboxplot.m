...
nof_ms = 6; % Number of measurements
nof_sets = 4; % Number of sets (different TTIs or no ZMQ)
sinr_avg_allMs = zeros(nof_sets,nof_ms);
brate_avg_allMs = zeros(nof_sets,nof_ms);
bler_avg_allMs = zeros(nof_sets,nof_ms);

file_name = "1_in_10_TTI/downsampled";
...
%             sub_file_name = "1_in_100_TTI_noDownsampling/";
            sub_file_name = file_name+"10x/";
%             sub_file_name = "1_in_10_TTI/downsampled10x/";
        case 3
%             sub_file_name = "1_in_10_TTI/downsampled10x/";
            sub_file_name = file_name+"100x/";
%             sub_file_name = "1_in_5_TTI_downsampled100x/";
        case 4
%             sub_file_name = "1_in_5_TTI_downsampled100x/";
            sub_file_name = file_name+"1000x/";
...
ylabel('SINR in dB')
grid on
set(gca, 'xticklabel', {'No ZMQ Comm', '10x DS','100x DS','1000x DS'})
...
title('1 in 10 TTI: SINR for various downsample-rates')
...
% set(gca, 'xticklabel', {'No ZMQ Comm','1 in 10 TTIs, 10x DS',...
%     '1 in 5 TTIs, 100x DS','Every TTI, 1000x DS'})
title('1 in 10 TTI: Throughput for various downsample-rates')
...
% set(gca, 'xticklabel', {'No ZMQ Comm','1 in 10 TTIs, 10x DS',...
%     '1 in 5 TTIs, 100x DS','Every TTI, 1000x DS'})
title('1 in 10 TTI: BLER for various downsample-rates')
